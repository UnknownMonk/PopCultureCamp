...
mongoose.connect(mongodb: //UnknownMonk:&roundcl0ud@ds239988.mlab.com:39988/yelpcamp);
        ...
        app.use(bodyParser.urlencoded({ extended: true })); app.set("view engine", "ejs"); app.use(express.static(__dirname + "/public")); app.use(methodOverride("_method")); app.use(flash());
